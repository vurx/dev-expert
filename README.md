# Fork from https://skillhub.cn/skills/user_741dc82b/dev-expert
...
| 版本 | 变更摘要 |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.17.0 | 新增 3 个工程纪律层专项 reference：AI 编码治理（ai-coding-governance）、面向 Agent 代码可读性（code-readability-for-agents）、LLM 应用安全（llm-application-security）；SKILL.md description/Step 2 专项纪律预判/领域路由表/专项映射/优先级矩阵/协同链同步扩展，README 文件结构与体量表同步 |
